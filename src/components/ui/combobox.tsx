      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            role="combobox"
            aria-expanded={open}
            className="border-input placeholder:text-muted-foreground focus-visible:ring-ring grid w-full grid-cols-[1fr_auto] rounded-md border bg-transparent px-4 py-[15px] text-left text-[clamp(16px,calc(16px+4*(100vw-768px)/672),20px)]! font-normal text-black! shadow-xs transition-colors focus-visible:ring-1 focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50"
          >
