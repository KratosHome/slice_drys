      ...
      >
        <div
          className={cn(
            'w-full',
            variant === 'grey' &&
              `bg-grey-review border px-[clamp(16px,calc(16px+32*(100vw-375px)/1065),48px)] py-[clamp(12px,calc(12px+12*(100vw-375px)/1065),24px)] before:-top-[clamp(12px,calc(12px+12*(100vw-375px)/1065),24px)] before:-translate-x-1/2 after:bottom-[clamp(6px,calc(6px+6*(100vw-375px)/1065),12px)] after:-translate-x-1/2 after:translate-y-1/2 md:w-[92%] md:border-none ${quotesStyle}`,
            variant === 'black' &&
