  ...
  return (
    <>
      ...
      >
        ...
        >
          <g clipPath="url(#clip0_2003_13)">
            <path
              d="M16 0.450684C7.16352 0.450684 0 7.6142 0 16.4507C0 23.954 5.16608 30.2504 12.135 31.9796V21.3403H8.83584V16.4507H12.135V14.3438C12.135 8.89804 14.5997 6.37388 19.9462 6.37388C20.96 6.37388 22.7091 6.57292 23.4246 6.77132V11.2033C23.047 11.1636 22.391 11.1438 21.5763 11.1438C18.953 11.1438 17.9392 12.1377 17.9392 14.7214V16.4507H23.1654L22.2675 21.3403H17.9392V32.3336C25.8618 31.3768 32.0006 24.6312 32.0006 16.4507C32 7.6142 24.8365 0.450684 16 0.450684Z"
          ...
          <defs>
            <clipPath id="clip0_2003_13">
              <rect
                width="32.0006"
                height="32"
                fill={`${variant === 'dark' ? 'white' : '#0F0F0F'}`}
                transform="translate(0 0.450684)"
              />
            </clipPath>
          </defs>
        </svg>
      ...
      >
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M0 16.4507C0 7.61413 7.16344 0.450684 16 0.450684C24.8366 0.450684 32 7.61413 32 16.4507C32 25.2872 24.8366 32.4507 16 32.4507C7.16344 32.4507 0 25.2872 0 16.4507ZM12.6 8.15068H19.4C20.3 8.25068 20.9 8.35068 21.4 8.55068C22 8.85068 22.4 9.05068 22.9 9.55068C23.4 10.0507 23.7 10.5507 23.9 11.0507C24.1 11.5507 24.3 12.1507 24.3 13.0507V19.8507C24.2 20.7507 24.1 21.3507 23.9 21.8507C23.6 22.4507 23.4 22.8507 22.9 23.3507C22.4 23.8507 21.9 24.1507 21.4 24.3507C20.9 24.5507 20.3 24.7507 19.4 24.7507H12.6C11.7 24.6507 11.1 24.5507 10.6 24.3507C10 24.0507 9.6 23.8507 9.1 23.3507C8.6 22.8507 8.3 22.3507 8.1 21.8507C7.9 21.3507 7.7 20.7507 7.7 19.8507V13.0507C7.8 12.1507 7.9 11.5507 8.1 11.0507C8.4 10.4507 8.6 10.0507 9.1 9.55068C9.6 9.05068 10.1 8.75068 10.6 8.55068C11.1 8.35068 11.7 8.15068 12.6 8.15068Z"
            fill={`${variant === 'dark' ? '#0F0F0F' : 'white'}`}
          />
        </svg>
      </Button>
